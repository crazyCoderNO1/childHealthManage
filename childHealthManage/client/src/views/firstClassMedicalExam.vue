<template>
    <div class="firstclassmedicalexam">
...
.firstclassmedicalexam .medicalExamAddCon{
    width: 100%;
    height: 48px;
}
.firstclassmedicalexam .medicalExamAddCon .rightBtn{
    position: relative;
    left: 368px;
}
.firstclassmedicalexam .medicalExamTableCon{
    width: 1100px;
    height: 100%;
}
