<template>
    <div class="thirdclassmedicalexam">
            ...
            .then(res => {
               ...
               // console.log(this.allTableData[0].class);
                for(let i=0;i<=this.allTableData.length;i++){
                    ...
                    if(this.allTableData[i].class == "幼儿三班"){
...
.thirdclassmedicalexam .medicalExamAddCon{
    width: 100%;
    height: 48px;
}
.thirdclassmedicalexam .medicalExamAddCon .rightBtn{
    position: relative;
    left: 368px;
}
.thirdclassmedicalexam .medicalExamTableCon{
    width: 1100px;
    height: 100%;
}
